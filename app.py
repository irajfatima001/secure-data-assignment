...
# st.session_state["page"] = choice  # Keep current page in sync
...
#                     st.experimental_set_query_params(page="Login")  # optional visual sync
#         else:
#             st.warning("⚠️ Fill both fields to proceed.")
...
#     if st.session_state["failed_attempts"] < 3:
#         st.info("ℹ️ You are not locked out, but you can still log in.")
